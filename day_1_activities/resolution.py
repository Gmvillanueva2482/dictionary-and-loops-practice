...
cps_id = (input("CPS ID:")
    ...
    print (new_student)
    print ("Total student in the system:"), len(students))
...
while True:
    ...
    if choice == "1":
        ...
        print(f"Grade: {result['Grade Level]'}")
        print(f"Primary Email: {result['primary_gmail]'}")
        print(f"Secondary Email: {result['secondary_gmail]'}")
        else:
